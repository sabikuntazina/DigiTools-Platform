...
<div className=' bg-[#101727] py-20 '>
        <footer className="footer lg:max-w-7xl lg:mx-auto sm:footer-horizontal text-gray-400 p-10">
      <div className='space-y-4'>
        <h2 className='font-extrabold text-xl md:text-4xl'>
            DigiTools
        </h2>
    <p className='text-gray-400'>
      Premium digital tools for creators, professionals, <br /> and businesses. Work smarter with our <br /> suite of powerful tools.
    </p>
  </div>
  <nav>
  ...
  <nav>
    <h6 className="footer-title text-white opacity-90">Resources</h6>
    ...
    <nav>
    <h6 className="footer-title text-white opacity-90">Social Links</h6>
...
<div className="footer pl-10 lg:max-w-7xl lg:mx-auto sm:footer-horizontal text-neutral-content items-center p-4">
