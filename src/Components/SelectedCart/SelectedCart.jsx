...
const SelectedCart = ({carts,removeCarts,setCarts}) => {
    ...
    return (
        <div className='lg:max-w-7xl lg:mx-auto my-20 shadow-2xl p-15 shadow-2xl rounded-2xl'>
          ...
          <button onClick={()=>setCarts([])} className='btn rounded-full bg-linear-to-bl from-violet-500 to-[#4F39F6] text-xl font-bold text-white w-full px-5 py-8'>Proceed to Checkout</button>
          </div>
          }
        </div>
    );
